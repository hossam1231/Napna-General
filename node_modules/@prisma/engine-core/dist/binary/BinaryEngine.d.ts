...
import type { BatchTransactionOptions, EngineConfig, EngineEventType, GetConfigResult, InteractiveTransactionOptions } from '../common/Engine';
...
export declare class BinaryEngine extends Engine {
    ...
    request<T>(query: string, headers?: QueryEngineRequestHeaders, _transaction?: InteractiveTransactionOptions<undefined>, numTry?: number): Promise<QueryEngineResult<T>>;
     ...
     */
    transaction(action: 'start', headers: Tx.TransactionHeaders, options?: Tx.Options): Promise<Tx.Info<undefined>>;
    transaction(action: 'commit', headers: Tx.TransactionHeaders, info: Tx.Info<undefined>): Promise<undefined>;
    transaction(action: 'rollback', headers: Tx.TransactionHeaders, info: Tx.Info<undefined>): Promise<undefined>;

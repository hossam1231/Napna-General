...
var import_runtimeHeadersToHttpHeaders = require("../common/utils/runtimeHeadersToHttpHeaders");
...
You very likely have the wrong "binaryTarget" defined in the schema.prisma file.`
  ...
  async request(query, headers = {}, _transaction, numTry = 1) {
    await this.start();
    this.currentRequestPromise = this.connection.post("/", stringifyQuery(query), (0, import_runtimeHeadersToHttpHeaders.runtimeHeadersToHttpHeaders)(headers));
  ...
  async requestBatch(queries, headers = {}, transaction, numTry = 1) {
    ...
    this.currentRequestPromise = this.connection.post("/", this.lastQuery, (0, import_runtimeHeadersToHttpHeaders.runtimeHeadersToHttpHeaders)(headers));
    ...
    if (action === "start") {
      ...
      const result = await import_Connection.Connection.onHttpError(
        this.connection.post(
          "/transaction/start",
          jsonOptions,
          (0, import_runtimeHeadersToHttpHeaders.runtimeHeadersToHttpHeaders)(headers)
        ),

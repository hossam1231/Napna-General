...
import type { BatchTransactionOptions, EngineConfig, EngineEventType } from '../common/Engine';
...
export declare class LibraryEngine extends Engine {
    ...
    request<T>(query: string, headers?: QueryEngineRequestHeaders): Promise<{
        data: T;
        elapsed: number;
    }>;
    requestBatch<T>(queries: string[], headers?: QueryEngineRequestHeaders, transaction?: BatchTransactionOptions): Promise<QueryEngineResult<T>[]>;

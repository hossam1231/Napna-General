...
import type { AuthenticationCredentialJSON, RegistrationCredentialJSON } from '@simplewebauthn/typescript-types';
...
declare type Params = AuthenticationCredentialJSON & RegistrationCredentialJSON & {
    username?: string;
    password?: string;

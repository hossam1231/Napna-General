...
_Object$defineProperty(exports, "PasswordValidationError", {
  enumerable: true,
  get: function () {
    return _errors2.PasswordValidationError;
  }
});
...
var _errors2 = require("./functions/dbAuth/errors");
...
var _errors3 = require("./validations/errors");
_forEachInstanceProperty(_context5 = _Object$keys(_errors3)).call(_context5, function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _errors3[key]) return;
  _Object$defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _errors3[key];

...
declare type WithOptionalMessage<T = Record<string, unknown>> = T & {
    /**
     * A message to be shown if the validation fails.
     */
    message?: string;
};
declare type WithRequiredMessage<T = Record<string, unknown>> = Required<WithOptionalMessage> & T;
...
export declare const validateWith: (func: () => void) => void;

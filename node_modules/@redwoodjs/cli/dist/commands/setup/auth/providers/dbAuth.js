...
exports.webPackages = exports.task = exports.notes = exports.libPath = exports.functionsPath = exports.config = exports.apiPackages = void 0;
...
const libPath = (0, _paths.getPaths)().api.lib.replace((0, _paths.getPaths)().base, '');
exports.libPath = libPath;
const functionsPath = (0, _paths.getPaths)().api.functions.replace((0, _paths.getPaths)().base, '');
...
const task = (0, _lib.addEnvVarTask)('SESSION_SECRET', secret, 'Used to encrypt/decrypt session cookies. Change this value and re-deploy to log out all users of your app at once.');

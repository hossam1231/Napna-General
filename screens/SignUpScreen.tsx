...
const SignUpScreen: React.FC<StackScreenProps<any>> = ({ navigation }) => {
  ...
  function signUpCheck() {
    ...
    if (value.email === "" || value.password === "") {
      ...
      setIsOpenTop(!isOpenTop);
    } else if (value.confirmedPassword != value.password) {
  ...
  async function signUp() {
    try {
      ...
      setValue({
        ...value,
        error: streamlineError(String(error.message), "firebase"),
      });
      setIsOpenTop(!isOpenTop);
    }
  }
      ...
      <Box safeArea p="2" w="90%" maxW="290" py="8">
        ...
        <VStack space={3} mt="5">
          ...
          <FormControl>
            ...
            <Input
              onChangeText={(text) =>
                setValue({ ...value, confirmedPassword: text })
              }
              type="password"
            />
          </FormControl>
          ...
          <Button onPress={signUpCheck} mt="2" colorScheme="indigo">
            Sign up
          </Button>
        </VStack>
      </Box>

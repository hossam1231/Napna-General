        ...
        >
          ...
          <div>
            ...
            <p className="mt-4 text-lg tracking-tight text-blue-200">
              Its hard to find a solution that fits all the time or maybe your
              on the edge. We get that, with a free consolation we can cover all
              the nooks your business may function in.
            </p>
          </div>
